...
<body>
    <div class="login-container" id="loginContainer">
        <div class="login-box">
            <button class="theme-toggle-login" onclick="toggleTheme()" id="themeBtn2">🌙</button>
            <div class="login-logo"><h1>🍯 AccBox</h1><p>安全管理您的账号小金库~</p></div>
            ...
            <form class="login-form active" id="loginForm" onsubmit="handleLogin(event)">
                <div class="form-group"><label class="form-label">用户名</label><input type="text" class="form-input" id="loginUsername" required></div>
                <div class="form-group"><label class="form-label">密码</label><input type="password" class="form-input" id="loginPassword" required></div>
                <button type="submit" class="btn-submit">登录</button>
            </form>
            <form class="login-form" id="registerForm" onsubmit="handleRegister(event)">
                <div class="form-group"><label class="form-label">用户名</label><input type="text" class="form-input" id="regUsername" required></div>
                <div class="form-group"><label class="form-label">密码</label><input type="password" class="form-input" id="regPassword" required></div>
                <div class="form-group"><label class="form-label">确认密码</label><input type="password" class="form-input" id="regPassword2" required></div>
            ...
            <div class="sidebar-header">
                ...
                <div class="user-panel" id="userPanel">
                    ...
                    <div class="user-panel-body">
                        ...
                        <div class="user-panel-item" onclick="toggleTheme()"><span id="themeBtn">🌙</span> 切换主题</div>
        ...
        <main class="main">
            <div class="toolbar">
                ...
                <div class="batch-actions" id="batchActions">
                    ...
                    <button class="btn-batch-delete" onclick="batchDelete()">删除</button>
                </div>
                <!-- 搜索框 -->
                <div class="search-box"><span class="search-icon">🔍</span><input type="text" id="searchInput" placeholder="搜索..." oninput="filterAccounts()"></div>
                <!-- 视图切换 -->
                ...
                <!-- 移动端按钮（带简要文字） -->
                <button class="btn-toolbar-sm mobile-only" id="btnBatchModeMobile" onclick="toggleBatchMode()" title="勾选">✅ 勾选</button>
                <div class="tools-menu-wrapper mobile-only">
                    <button class="btn-toolbar-sm" onclick="toggleToolsMenu()" title="更多">⚙️ 更多</button>
    ...
    <div class="modal-overlay" id="accountModal">
        <div class="modal">
            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                    <div class="form-group"><label class="form-label">邮箱/账号</label><input type="text" class="form-input" id="accEmail"></div>
                    <div class="form-group"><label class="form-label">密码（可选）</label><input type="text" class="form-input" id="accPassword"></div>
                </div>
            ...
            <div class="modal-footer"><button class="btn-cancel" onclick="closeAccountModal()">取消</button><button class="btn-save" onclick="saveAccount()">保存</button></div>
        </div>
    </div>
        ...
        <div class="modal">
            ...
            <div class="modal-body">
                <div class="import-section">
                    ...
                    <div class="hint-box"><p>选择之前导出的JSON备份文件，包含所有账号信息。</p></div>
                    <div class="form-group">
                        <label class="import-file-label" for="importFile">
                            <span class="import-file-icon">📄</span>
                            <span class="import-file-text">选择JSON文件</span>
                            <span class="import-file-hint">选择后自动导入</span>
                        </label>
